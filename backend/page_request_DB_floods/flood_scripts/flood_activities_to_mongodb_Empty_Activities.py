...
def run():
    ...
    activitiesCollection.ensure_index( [("Loc", pymongo.GEOSPHERE) ] )
    activitiesCollection.ensure_index( [("Classroom", pymongo.ASCENDING)] )
    activitiesCollection.ensure_index( [("Building", pymongo.ASCENDING)] )
    activitiesCollection.ensure_index( [("Start_Time", pymongo.ASCENDING)] )
    activitiesCollection.ensure_index( [("Date_Time", pymongo.ASCENDING)] )
